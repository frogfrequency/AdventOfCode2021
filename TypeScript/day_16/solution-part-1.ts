...
let testInput1: string = 'D2FE28';

let testInput2: string = '38006F45291200'

let testInput3: string = 'EE00D40C823060'


// import { puzzleInput } from "./data/puzzle-input.js"

const input: string = testInput2;
...
function processString(transmission: string): number {
    ...
    // other than typeId 4 - operator
        ...
        if (lengthTypeId === '0') {
            ...
            let nextTransmissionPart: string = body.slice(16, body.length);
